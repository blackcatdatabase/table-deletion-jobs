...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'deletion_jobs'; }
    public static function contractView(): string { return 'vw_deletion_jobs'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'entity_table', 'entity_pk', 'reason', 'hard_delete', 'scheduled_at', 'started_at', 'finished_at', 'status', 'error', 'created_by', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'entity_table', 'entity_pk' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'created_by' ]; }
