...
namespace BlackCat\Database\Packages\DeletionJobs\Mapper;

use BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto;
use BlackCat\Database\Packages\DeletionJobs\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO DeletionJobDto:
 ...
 */
final class DeletionJobDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'entity_table' => 'entityTable', 'entity_pk' => 'entityPk', 'reason' => 'reason', 'hard_delete' => 'hardDelete', 'scheduled_at' => 'scheduledAt', 'started_at' => 'startedAt', 'finished_at' => 'finishedAt', 'status' => 'status', 'error' => 'error', 'created_by' => 'createdBy', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [ 'hard_delete' ];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'created_by' ];
    /** @var string[] */
     ...
     * @return DeletionJobDto
     */
    public static function fromRow(array $row): DeletionJobDto
    {
        /** @var DeletionJobDto */
        return DtoHydrator::fromRow(
            DeletionJobDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?DeletionJobDto
    {
     ...
     *
     * @param DeletionJobDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(DeletionJobDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(DeletionJobDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(DeletionJobDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,DeletionJobDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,DeletionJobDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(DeletionJobDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,DeletionJobDto>
     */
