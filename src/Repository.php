...
namespace BlackCat\Database\Packages\DeletionJobs;
...
use BlackCat\Database\Packages\DeletionJobs\Repository\DeletionJobRepository as GeneratedRepository;
...
{
  private DeletionJobRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof DeletionJobRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected DeletionJobRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto|null { return $this->repo->getById($id, $asDto); }
