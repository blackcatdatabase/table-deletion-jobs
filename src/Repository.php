...
use BlackCat\Database\Packages\DeletionJobs\Repository\DeletionJobRepository;
...
{
    private DeletionJobRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new DeletionJobRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DeletionJobs\Dto\DeletionJobDto|null
    {
