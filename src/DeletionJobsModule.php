...
final class DeletionJobsModule implements ModuleInterface
{
    public function name(): string { return 'table-deletion_jobs'; }
    public function table(): string { return 'deletion_jobs'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_dj_status_sched' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_dj_status_sched' ],
            'foreignKeys' => [ 'fk_dj_user' ],
        ];
    }
}
