...
| Pkg folder | [packages\deletion-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\deletion-jobs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package deletion-jobs -Apply
