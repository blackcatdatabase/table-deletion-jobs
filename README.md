...
- Pkg folder: [packages\deletion-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\deletion-jobs)
...
graph LR
  ...
  deletion_jobs["deletion_jobs"]:::center
  deletion_jobs -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package deletion-jobs -Apply
